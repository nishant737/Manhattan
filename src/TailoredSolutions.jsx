    ...
    <section className="tailored-solutions-section" ref={sectionRef}>
      ...
      <div className="solutions-ticker">
        <div className="ticker-content">
          <span>LUXURY RESIDENCES · MANGALORE'S FINEST · ARCHITECTURAL EXCELLENCE · ICONIC ARCHITECTURE · SPACIOUS LIVING · ELEVATED LIVING · LUXURY RESIDENCES · MANGALORE'S FINEST · ARCHITECTURAL EXCELLENCE · ICONIC ARCHITECTURE · SPACIOUS LIVING · ELEVATED LIVING ·</span>
        </div>
      </div>
